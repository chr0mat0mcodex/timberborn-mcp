...
Stand: 2026-09-20. Aktuelle eigene Mod: **0.17.2**, installiert und gezielt live abgenommen.
...
| Ebene | Beleg |
| --- | --- |
| Automatisch | 388 reguläre Tests: 375 Unit, 13 Integration; drei opt-in Live-Tests im Standardlauf übersprungen |
...
[19 Leser + 19 freizugebende Werkzeuge](docs/tools.md). Die Steuerungsbasis ist vorhanden.
Es fehlen insbesondere vollständige globale Güterdaten, Alerts/Problemdetails,
Produktions-/Verbrauchsbilanzen und ein vollständiger Erreichbarkeitsnachweis.
