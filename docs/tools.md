...
Stand: Agent Bridge 0.19.2 (installiert; alle 26 Leser live geprüft, Terrain-Pilot Farm/Holzfäller bestanden). Aus `NativeTools.Catalog` mit allen Freigaben abgeglichen:
