...
Stand: Agent Bridge 0.20.0 (installiert; alle 29 Leser live geprüft, gezielte Diagnosepiloten bestanden). Aus `NativeTools.Catalog` mit allen Freigaben abgeglichen:
