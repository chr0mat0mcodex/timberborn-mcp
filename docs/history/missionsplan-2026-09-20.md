> Historisches Planungsdokument, archiviert am 2026-09-20. Frühere Freigaben, Versionsstände und offene Kästchen sind keine aktuelle Zustandsbeschreibung. Aktuell: [Projektstand](../../PROJECT_STATE.md) und [Mission](../../missionsplan.md).
...
Der ausgearbeitete [Phase-2-Plan](../phase-2-plan.md) enthält Funktionsmatrix, belegten API-Stand,
...
[Pilotbericht](../phase-2a-results.md): Wohnbaukatalog live nutzbar; Betten/Güter/Arbeitskräfte haben
...
[Machbarkeitsbericht](../architecture/native-game-api.md) trennt Metadatennachweis von Laufzeittests.
...
in [docs/references](../references/README.md) dokumentiert. Native Mod braucht keine
...
kein automatisches Retry oder Fertigbau. [Vertrag und Live-Abnahme](../path-placement.md).
...
Keine neue Bauaktion ausgeführt. Details: [Gebäudeabfrage](../building-observations.md).
...
Baustelle mit Kosten/Fortschritt/Baudistrikt nachlesen. [Vertrag](../lodge-placement.md).
...
Spielsperren-Aufhebung. [Vertrag und Hin-/Rücktest](../simulation-control.md).
...
bewerten; Besetzung ist kein Produktionsnachweis. [Vertrag](../building-operations.md).
...
Sessionbindung und sauberes Schließen. [Recherche und Zukunftsplan](../player-question-popup.md).
...
und Hin-/Rücktest offen. [Vertrag](../workplace-staffing.md).
...
[Vertrag und Abnahme](../simulation-control.md). Sollbesetzungs-Livetest in 0.11.0 ebenfalls bestanden.
...
[Vertrag und Abnahmeplan](../priorities-construction-areas.md). Der frühere Personaltest
...
Harzernte behaupten. [Vertrag und Grenzen](../removal-and-pine-protection.md).
...
[Vertrag](../vegetation-state.md). Historische 124 Kandidaten waren ungefiltert;
...
[Vertrag und Abnahmeplan](../generic-building.md). Keine neue Fremdmod-Abhängigkeit,
...
[API-Belege, Vertragsvorschlag und Grenzen](../alerts-plan.md).
