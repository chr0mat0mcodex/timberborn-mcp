    ...
    public static IEnumerable<Tool> Catalog()
    {
        ...
        foreach(var (name,route) in Routes){
            ...
            yield return new Tool{Name=name,Description=(route switch{
                ...
                _=>"Liest gespeicherte globale Güterstatistik des Spiels in dessen Reihenfolge: Cycle, Day, Stock, Capacity, Production und Consumption. Produktions-/Verbrauchszähler stammen aus dem Spiel, nicht aus Vorratsdifferenzen. netProduction=Production-Consumption; stockChange separat. Summen gelten nur für die gelesene Seite. Keine angenommene Abtastdauer oder momentane Rate; leere Historie bedeutet fehlende Daten. Maximal 32 Einträge pro Seite."})+" Ab Bridge 0.19.0; korrigierter Reichweitenzugriff und Sofort-Wegsuche ab 0.19.1. Rein lesend; Navigationsdaten können nach Spieländerungen verzögert aktualisiert werden.",
