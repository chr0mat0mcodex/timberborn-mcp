    ...
    public static IEnumerable<Tool> Catalog(bool priorities,bool areas)
    {
        ...
        foreach(var (name,route) in Routes){
            ...
            string description=route switch{
                ...
                "areas"=>"Liest markierte Zellen kolonieweit, gefiltert nach Flächenart, maximal 32 pro Seite. crops/tree_planting sind Pflanzaufträge, keine frei definierten Erntezonen. tapping listet nur nachweislich lebende, ausgewachsene, nicht sterbende Kiefern ohne gemeldeten Wasserstress und ohne Fällmarkierung (mit vegetation-Zustand); keine gespeicherte Zone, kein Ernte-/Reichweitennachweis. Jede Seite frisch.",
