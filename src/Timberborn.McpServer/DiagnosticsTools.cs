    ...
    public static IEnumerable<Tool> Catalog()
    {
        ...
        foreach(var (name,route) in Routes){
            ...
            yield return new Tool{Name=name,Description=(route switch{
                "needs"=>"Liest pro Bedürfnis die beobachteten Biber, aktivierten Bedürfnisse sowie native Warn-/Kritisch-Flags und Punkteverteilung. Zähler enthalten nur aktivierte Bedürfnisse und können sich überschneiden. warning ist ausschließlich das rohe Unter-Warnschwelle-Flag, keine akute UI-Warnung; auch ungenutzter Komfort und inaktive negative Bedürfnisse können es setzen. Zusammen mit critical, active und unfavorable interpretieren. Fehlende NeedManager werden separat gezählt. Keine Namen, keine aus Meldungsabwesenheit geratene Gesundheit. Maximal 32 Bedürfnisse pro Seite, nach ID sortiert.",
                "beaver-needs"=>"Liest native Bedürfniswerte und Warn-/Kritisch-Flags eines Bibers mit Session-Prüfung; ID aus Arbeiterliste oder Warnungszielen. Auch deaktivierte Bedürfnisse mit enabled=false. warning ist nur das native Unter-Warnschwelle-Flag, keine akute UI-Warnung; mit active, critical und favorable interpretieren. Maximal 32 Bedürfnisse pro Seite. worldPosition verwendet Unity-Weltachsen. supported=false bedeutet fehlende Beobachtung, nicht gesund.",
