...
public static class ActivityTools
{
    ...
    public static async Task<JsonObject> Read(NativeClient client,JsonElement args,CancellationToken ct)
    {
        ...
        if(e.BridgeVersion is not ("0.16.0" or "0.17.0" or "0.17.1" or "0.17.2" or "0.18.0" or "0.19.0" or "0.19.1" or "0.19.2" or "0.20.0") || d.Capacity!=128 || d.Items is null || d.Items.Length>32 || d.Revision<0 ||
