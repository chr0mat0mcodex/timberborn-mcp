...
public sealed class BridgeHttpServer : IDisposable
{
    ...
    private readonly bool enablePriorities, enableAreas, enableRemoval, enableBuildingPlacement, enableBuildingSettings, enableResearch;
    ...
    private async Task Handle(HttpListenerContext context)
    {
        ...
        else if (!MethodAllowed(request.HttpMethod, request.Url!.AbsolutePath, request.HasEntityBody, enableValidation, enablePlacement, enableLodgePlacement, enableSpeedControl, enableStaffing, enablePriorities, enableAreas, enableRemoval, enableBuildingPlacement, enableBuildingSettings, enableResearch))
