...
public sealed partial class NativeClient
{
    ...
    {
        if(e.BridgeVersion is not ("0.18.0" or "0.19.0" or "0.19.1" or "0.19.2" or "0.20.0" or "0.20.1" or "0.21.0")||offset!=r.Offset||limit!=r.Limit||total<0||count!=Math.Min(limit,Math.Max(0,total-offset))||
